...
beforeEach(() => {
  tileRaw = fs.readFileSync('./src/fourwings-worker/test/mocks/carriers-2-3-2.pbf')
...
test('Big tile, big delta, single frame mode, last feature', () => {
  const bigTileRaw = fs.readFileSync('./src/fourwings-worker/test/mocks/carriers-1-1-0.pbf')
